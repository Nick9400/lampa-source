...
function launch(preroll, call, fail){
    ...
    // Заставка это короткая анимация-подводка перед самим роликом: следим только за тем,
    // что её не скрыли и не удалили (перекрытие проверяем уже на самом рекламном блоке)
