...
Поля, влияющие на рекламу (`iptv`, `torrent_hash`, `youtube`, `continue_play`, `vast_*`), фиксируются до этого события; их изменение в обработчике на показ рекламы не влияет.
